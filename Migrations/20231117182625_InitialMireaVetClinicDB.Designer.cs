...
namespace mirea_vetclinic.Migrations
{
    ...
    [Migration("20231117182625_InitialMireaVetClinicDB")]
    partial class InitialMireaVetClinicDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mirea_vetclinic.Domain.Models.PetSpecie", b =>
                {
                    ...
                    b.HasKey("PetId", "SpecieId")
                        .HasName("pk_pet_specie");

                    b.HasIndex("SpecieId")
                        .HasDatabaseName("ix_pet_specie_specie_id");

                    b.ToTable("pet_specie", (string)null);
                });
            ...
            modelBuilder.Entity("mirea_vetclinic.Domain.Models.Specie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mirea_vetclinic.Domain.Models.Pet", b =>
                {
                    ...
                    b.HasOne("mirea_vetclinic.Domain.Models.Specie", "Specie")
                        .WithMany("Pets")
            ...
            modelBuilder.Entity("mirea_vetclinic.Domain.Models.PetSpecie", b =>
                {
                    b.HasOne("mirea_vetclinic.Domain.Models.Pet", "Pet")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pet_specie_pets_pet_id");
                    ...
                    b.HasOne("mirea_vetclinic.Domain.Models.Specie", "Specie")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pet_specie_species_specie_id");
