...
namespace mirea_vetclinic.Migrations
{
    ...
    [Migration("20231119135853_ProcedureVisitManyMany")]
    partial class ProcedureVisitManyMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcedureVisit", b =>
                {
                    ...
                    b.HasKey("ProceduresId", "VisitsId")
                        .HasName("pk_procedure_visit");

                    b.HasIndex("VisitsId")
                        .HasDatabaseName("ix_procedure_visit_visits_id");

                    b.ToTable("procedure_visit", (string)null);
                });
            ...
            modelBuilder.Entity("ProcedureVisit", b =>
                {
                    b.HasOne("mirea_vetclinic.Domain.Models.Procedure", null)
                        .WithMany()
                        .HasForeignKey("ProceduresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_procedure_visit_procedures_procedures_id");
                    ...
                    b.HasOne("mirea_vetclinic.Domain.Models.Visit", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_procedure_visit_visits_visits_id");
                });
